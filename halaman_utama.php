			...
			<nav>
				<div id="menu-wrap">
					...
					?>
						...
						<a href="logout.php" onClick="return confirm('Apakah anda yakin untuk logout, <?php echo $_SESSION['username']; ?>?')">
			...
			<div id="isi">
				...
				<div id="menu_kiri">
					...
					<div id="menu_sosial">
						...
						<h2>Sosial Media</h2>
						<hr color="#0263A0"><br>
						<p>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.instagram.com/greggygf" target="_blank"><img src="logo/instagram.png" width="40" height="40" align="center">&nbsp;&nbsp;&nbsp;&nbsp;</a>
							<a href="http://www.facebook.com/bluohazard" target="_blank"><img src="logo/facebook.png" width="40" height="40" align="center">&nbsp;&nbsp;&nbsp;&nbsp;</a>
